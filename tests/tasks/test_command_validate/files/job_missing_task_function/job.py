...
if __name__ == '__main__':
    ...
    job.run_task_parallel('task_foo', 'missing_task_function', arguments=[("arg1", ""), ("arg2", "run_in_parallel")])
    job.run_task_parallel('task_foo', 'missing_task_function', arguments=[("arg1", "also"), ("arg2", "run_in_parallel")])

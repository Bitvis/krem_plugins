...
class SyntaxValidator():
    ...
    def load_config(self):
        ...
        self.error.warnings_on = validator_config.job_script_syntax_warnings_on
...
class TaskValidator():
    ...
    def load_config(self):
        self.error.warnings_on = validator_config.check_tasks_warnings_on
...
class RunTaskValidator():
    ...
    def load_config(self):
        self.job_start_call = validator_config.job_script_start_line
        self.job_end_call = validator_config.job_script_end_line
        self.error.warnings_on = validator_config.run_task_function_call_warnings_on
